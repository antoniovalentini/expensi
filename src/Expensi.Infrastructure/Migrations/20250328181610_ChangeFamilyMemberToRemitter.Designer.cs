...
namespace Expensi.Infrastructure.Migrations
{
    ...
    [Migration("20250328181610_ChangeFamilyMemberToRemitter")]
    partial class ChangeFamilyMemberToRemitter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Expensi.Core.Models.Remitter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Expensi.Core.Models.Expense", b =>
                {
                    ...
                    b.HasOne("Expensi.Core.Models.Remitter", "Remitter")
                        .WithMany("Expenses")
